...
namespace UnitTests.Api.Wine.CreateUpdateWine
{
    public class CreateUpdateWineRepositoryTests : WineTestBase
    {
        ...
        [Fact]
        public void UpdateWine_ShouldUpdateWine_WhenGivenExistingRegionVineyardAndWineType()
        {
            // __Arrange __
            var model = new UpdateWineRequest()
            {
        ...
        [Fact]
        public void UpdateWine_ShouldUpdateWine_WhenGivenExistingRegionVineyardAndWineTypeAsDuplicates()
        {
            // __Arrange __
            var model = new UpdateWineRequest
            {
        ...
        [Fact]
        public void UpdateWine_ShouldReturnFalse_WhenGivenRequestModelWithoutId()
        {
            // __Arrange __
            var model = new UpdateWineRequest
            {
